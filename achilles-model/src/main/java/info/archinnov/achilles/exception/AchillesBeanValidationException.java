...
public class AchillesBeanValidationException extends AchillesException {
    ...
    public AchillesBeanValidationException() {
        super();
    }

    public AchillesBeanValidationException(String message) {
        super(message);
    }

    public AchillesBeanValidationException(String message, Throwable throwable) {
