...
public class AchillesTranscodingException extends AchillesException {
    ...
    public AchillesTranscodingException() {
        super();
    }

    public AchillesTranscodingException(String message) {
        super(message);
    }

    public AchillesTranscodingException(String message, Throwable throwable) {
