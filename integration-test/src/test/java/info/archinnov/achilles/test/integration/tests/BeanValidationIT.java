...
public class BeanValidationIT {
	...
	public void should_use_custom_bean_validator_interceptor() throws Exception {
		...
		String entityPackage = EntityWithGroupConstraint.class.getPackage().getName();
		...
		configMap.put(ConfigurationParameters.ENTITY_PACKAGES_PARAM, entityPackage);
		...
		PersistenceManagerFactory managerFactory = PersistenceManagerFactoryBuilder.build(configMap);
