...
public class EventInterceptorIT {
    ...
    private PersistenceManager manager2 = CassandraEmbeddedServerBuilder
            ...
            .withAchillesConfigParams(ImmutableMap.<String, Object>of(EVENT_INTERCEPTORS_PARAM, postRemoveInterceptors))
    ...
    private PersistenceManager manager3 = CassandraEmbeddedServerBuilder
            ...
            .withAchillesConfigParams(ImmutableMap.<String, Object>of(EVENT_INTERCEPTORS_PARAM, asList(postLoadForClustered)))
            .cleanDataFilesAtStartup(true)
            .buildPersistenceManager();
