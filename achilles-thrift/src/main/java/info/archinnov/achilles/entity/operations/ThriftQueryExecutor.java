...
public class ThriftQueryExecutor
{
	...
	public <T> List<T> get(final ClusteredQuery<T> query)
	{
	...
	public <T> Iterator<T> iterator(final ClusteredQuery<T> query)
	{
		ThriftPersistenceContext context = buildContext(query);
		EntityMeta meta = query.getMeta();
		PropertyMeta<?, ?> pm = meta.getFirstMeta();
	...
	public <T> void remove(final ClusteredQuery<T> query)
	{
		ThriftPersistenceContext context = buildContext(query);
		EntityMeta meta = query.getMeta();
		PropertyMeta<?, ?> pm = meta.getFirstMeta();
	...
	private <T> ThriftPersistenceContext buildContext(final ClusteredQuery<T> query)
	{
