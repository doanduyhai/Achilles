...
public class ThriftEntityManagerFactory extends AchillesEntityManagerFactory {
     ...
     *            <br/>
     *            <ul>
     *            <li>"achilles.entity.packages" <strong>(MANDATORY)</strong>: list of java packages for entity
     *            scanning, separated by comma.<br/>
     *            <br/>
     ...
     *            </ul>
     *            <ul>
     *            <li>"achilles.cassandra.cluster": instance of pre-configured
     *            <em>me.prettyprint.hector.api.Cluster</em> object from Hector API</li>
     *            <li>"achilles.cassandra.keyspace": instance of pre-configured
     *            <em>me.prettyprint.hector.api.Keyspace</em> object from Hector API</li>
     *            </ul>
     * 
     *            <strong>Either "achilles.cassandra.cluster" or
     *            "achilles.cassandra.host"/"achilles.cassandra.cluster.name" parameters should be provided</strong> <br/>
     *            <br/>
     *            <strong>Either "achilles.cassandra.keyspace" or "achilles.cassandra.keyspace.name" parameters should
     *            be provided</strong>
     * 
     *            <hr/>
     *            <h1>DDL Parameter</h1>
     *            <br/>
     *            <ul>
     *            <li>"achilles.ddl.force.column.family.creation" <strong>(OPTIONAL)</strong>: create missing column
     *            families for entities if they are not found. Default = 'false'.<br/>
     *            <br/>
     *            &nbsp;&nbsp;If "achilles.ddl.force.column.family.creation" = false and no column family is found for
     *            any entity, Achilles will raise an <strong>AchillesInvalidColumnFamilyException</strong><br/>
     *            <br/>
     *            </li>
     *            </ul>
     *            <hr/>
     ...
     *            <br/>
     *            <ul>
     *            <li>"achilles.json.object.mapper.factory" <strong>(OPTIONAL)</strong>: an implementation of the
     *            <em>info.archinnov.achilles.json.ObjectMapperFactory</em> interface to build custom <strong>Jackson
     *            ObjectMapper</strong> based on entity class<br/>
     *            <br/>
     *            </li>
     *            <li>achilles.json.object.mapper <strong>(OPTIONAL)</strong>: default <strong>Jackson
     *            ObjectMapper</strong> to use for serializing entities<br/>
     *            <br/>
     *            &nbsp;&nbsp;If both "achilles.json.object.mapper.factory" and "achilles.json.object.mapper"
     *            parameters are provided, Achilles will ignore the "achilles.json.object.mapper" value and use the
     *            "achilles.json.object.mapper.factory"<br/>
     *            <br/>
     *            If none is provided, Achilles will use a default <strong>Jackson ObjectMapper</strong> with the
     ...
     *            <li>AnnotationIntrospector pair : primary = <strong>JacksonAnnotationIntrospector</strong>, secondary
     *            = <strong>JaxbAnnotationIntrospector</strong></li>
     *            </ol>
     *            </li>
     *            </ul>
     *            <hr/>
     ...
     *            <br/>
     *            <ul>
     *            <li>"achilles.consistency.read.default" <strong>(OPTIONAL)</strong>: default read consistency level
     *            for all entities<br/>
     *            <br/>
     *            </li>
     *            <li>"achilles.consistency.write.default" <strong>(OPTIONAL)</strong>: default write consistency level
     *            for all entities<br/>
     *            <br/>
     *            </li>
     *            <li>"achilles.consistency.read.map" <strong>(OPTIONAL)</strong>: map(String,String) of read
     *            consistency levels for column families<br/>
     *            <br/>
     *            &nbsp;&nbsp;Example:<br/>
     *            <br/>
     ...
     *            <br/>
     *            </li>
     *            <li>"achilles.consistency.write.map" <strong>(OPTIONAL)</strong>: map(String,String) of write
     *            consistency levels for column families<br/>
     *            <br/>
     *            &nbsp;&nbsp;Example:<br/>
     *            <br/>
     ...
     *            <br/>
     *            <ul>
     *            <li>"achilles.consistency.join.check" <strong>(OPTIONAL)</strong>: whether check for join entity in
     *            Cassandra before inserting join primary key<br/>
     *            <br/>
     *            <strong>Warning: enable this option guarantees stronger data consistency but with the expense of
     *            read-before-write for each join entity insertion</strong> <br/>
     *            </li>
     *            </ul>
     */
     ...
     */
    @Override
    public ThriftEntityManager createEntityManager(Map map) {
        log.info("Create new Thrift-based Entity Manager with properties");
        // TODO override configContext with provided properties
        return new ThriftEntityManager(this, Collections.unmodifiableMap(entityMetaMap), thriftDaoContext,
                configContext);
    }
