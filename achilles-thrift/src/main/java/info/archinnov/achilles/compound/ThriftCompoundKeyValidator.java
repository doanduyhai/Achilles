...
public class ThriftCompoundKeyValidator extends CompoundKeyValidator {
	...
	public <K> void validateBoundsForQuery(PropertyMeta propertyMeta, K start, K end, OrderingMode ordering) {
		...
		if (start != null && end != null) {
			if (propertyMeta.isEmbeddedId()) {
				...
				validateComponentsForSliceQuery(Arrays.<Object> asList(start), Arrays.<Object> asList(end), ordering);
			}
		}
	}

	@Override
	public void validateComponentsForSliceQuery(List<Object> startComponentValues, List<Object> endComponentValues,
