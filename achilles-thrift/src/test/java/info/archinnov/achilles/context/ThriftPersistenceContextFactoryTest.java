...
public class ThriftPersistenceContextFactoryTest {
	...
	public void setUp() throws Exception {
		...
		factory = new ThriftPersistenceContextFactory(daoContext,
				configContext, entityMetaMap);
		Whitebox.setInternalState(factory, ReflectionInvoker.class, invoker);
	}

	@Test
	public void should_create_new_context_for_entity_with_consistency_and_ttl()
			throws Exception {
	...
	public void should_create_new_context_with_primary_key() throws Exception {
		...
		ThriftPersistenceContext context = factory.newContext(
				CompleteBean.class, primaryKey,
				OptionsBuilder.withConsistency(EACH_QUORUM).ttl(98));
	...
	public void should_create_new_context_for_slice_query() throws Exception {
		...
		ThriftPersistenceContext actual = factory.newContextForSliceQuery(
				CompleteBean.class, primaryKey, EACH_QUORUM);
