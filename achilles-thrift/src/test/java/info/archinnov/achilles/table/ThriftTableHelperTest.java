...
public class ThriftTableHelperTest
{
    ...
    @Test
    public void should_build_counter_wide_row() throws Exception
    {
        ...
        when(helper.determineCompatatorTypeAliasForCompositeCF(counterWideMapMeta, true)).thenReturn(
                "typeAlias");

        ColumnFamilyDefinition cfDef = thriftTableHelper.buildWideRowCF("keyspace", counterWideMapMeta,
                Long.class, "cf", "entity");
