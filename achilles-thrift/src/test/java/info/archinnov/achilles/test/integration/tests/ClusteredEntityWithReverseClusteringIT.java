...
import static info.archinnov.achilles.test.integration.entity.ClusteredEntityWithReverseClustering.*;
...
public class ClusteredEntityWithReverseClusteringIT {
	...
	public void should_query_with_default_params() throws Exception {
		...
		assertThat(entities.get(2).getValue()).isEqualTo(clusteredValuePrefix + 2);
