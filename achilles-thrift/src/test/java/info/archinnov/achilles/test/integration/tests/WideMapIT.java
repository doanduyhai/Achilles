...
{
	private ThriftGenericWideRowDao wideMapDao = getColumnFamilyDao(
	...
	public void should_insert_values() throws Exception
	{
		...
		List<Pair<Composite, String>> columns = wideMapDao.findColumnsRange(bean.getId(),
	...
	public void should_insert_value_with_ttl() throws Exception
	{
		...
		List<HColumn<Composite, String>> columns = wideMapDao.findRawColumnsRange(
	...
	public void should_remove_value() throws Exception
	{
		...
		List<String> foundStrings = wideMapDao.findValuesRange(bean.getId(), null, null,
				false, 5);
