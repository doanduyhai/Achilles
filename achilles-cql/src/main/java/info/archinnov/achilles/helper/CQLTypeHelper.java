...
/**
 * CQLDataTypeConverter
 * 
 * @author DuyHai DOAN
 * 
 */
public class CQLTypeHelper
{
	...
	static
	{
		...
		try
		{
			...
			rowPropertyInvoker
					.put(Long.class, Row.class.getDeclaredMethod("getLong", String.class));
			rowPropertyInvoker
					.put(long.class, Row.class.getDeclaredMethod("getLong", String.class));

			rowPropertyInvoker
					.put(Date.class, Row.class.getDeclaredMethod("getDate", String.class));
			...
			rowPropertyInvoker
					.put(UUID.class, Row.class.getDeclaredMethod("getUUID", String.class));
		...
		{
			throw new AchillesException("Cannot find getter in '" + Row.class.getCanonicalName()
					+ "' ", e);
		}
