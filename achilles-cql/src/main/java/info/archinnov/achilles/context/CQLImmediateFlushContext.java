...
public class CQLImmediateFlushContext extends
		CQLAbstractFlushContext<CQLImmediateFlushContext> {
	private static final Logger log = LoggerFactory
			.getLogger(CQLImmediateFlushContext.class);
	...
	public CQLImmediateFlushContext duplicate() {
		return new CQLImmediateFlushContext(daoContext, boundStatementWrappers,
				consistencyLevel);
	}
}
