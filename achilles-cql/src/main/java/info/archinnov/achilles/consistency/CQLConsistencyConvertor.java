...
public class CQLConsistencyConvertor {
	...
	static {
		fromAchillesToCQL.put(ConsistencyLevel.ANY,
				com.datastax.driver.core.ConsistencyLevel.ANY);
		fromAchillesToCQL.put(ConsistencyLevel.ONE,
				com.datastax.driver.core.ConsistencyLevel.ONE);
		fromAchillesToCQL.put(ConsistencyLevel.TWO,
		...
		fromAchillesToCQL.put(ConsistencyLevel.ALL,
	...
	public static com.datastax.driver.core.ConsistencyLevel getCQLLevel(
		...
		com.datastax.driver.core.ConsistencyLevel cqlLevel = fromAchillesToCQL
				.get(achillesLevel);
		if (cqlLevel == null) {
