...
public class PersistenceManagerFactory {
	...
	protected void addEventInterceptorsToEntityMetas() {
		List<EventInterceptor<?>> eventInterceptors = argumentExtractor.initEventInterceptor(configurationMap);
	...
	private boolean isEventInterceptorInterface(Type type) {
		return (type instanceof ParameterizedType)
				&& EventInterceptor.class.getName().equals(
						StringUtils.removeStart(((ParameterizedType) type).getRawType().toString(), "interface "));
	}
	...
	public static class PersistenceManagerFactoryBuilder {
		...
		public PersistenceManagerFactoryBuilder withEventInterceptors(List<EventInterceptor<?>> eventInterceptors) {
