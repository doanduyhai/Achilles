...
public class CQLEntityMapper extends EntityMapper {
	...
	public void setPropertyToEntity(Row row, PropertyMeta pm, Object entity) {
		if (row != null) {
			if (pm.isEmbeddedId()) {
				Object compoundKey = cqlRowInvoker.invokeOnRowForCompoundKey(
						row, pm);
	...
	public void setJoinValueToEntity(Object value, PropertyMeta pm,
			Object entity) {
		invoker.setValueToField(entity, pm.getSetter(), value);
	}

	public <T> T mapRowToEntity(Class<T> entityClass, Row row,
