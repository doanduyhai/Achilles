...
public class Cql3Test {
    ...
    @Rule
    public CreateTableRule createTable = new CreateTableRule();
    ...
    public void should_insert() throws Exception {
        ...
        String select = QueryBuilder.select("firstname", "age").from("cql3_user").where(filterById).toString();
    ...
    public void should_execute_prepared_statement() throws Exception {
        ...
        BoundStatement boundStatement = preparedStatement.bind(100004L, "FN4", "LN4", new Integer(34));
