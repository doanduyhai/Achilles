...
public class ClusteredEntityWithJoinEntityIT {
	...
	public AchillesInternalCQLResource resource = new AchillesInternalCQLResource(
			Steps.AFTER_TEST, "clustered_with_join_value");
	...
	public void should_persist_and_find() throws Exception {
		...
		ClusteredEntityWithJoinEntity found = em.find(
				ClusteredEntityWithJoinEntity.class, compoundKey);
	...
	public void should_merge_and_get_reference() throws Exception {
		...
		ClusteredEntityWithJoinEntity found = em.getReference(
				ClusteredEntityWithJoinEntity.class, compoundKey);
	...
	public void should_merge_modifications() throws Exception {
		...
		compoundKey = new ClusteredKey(RandomUtils.nextLong(), "name");
		User user = new User(RandomUtils.nextLong(), "firstname", "lastname");
		User newUser = new User(RandomUtils.nextLong(), "new_firstname",
				"new_lastname");
		entity = new ClusteredEntityWithJoinEntity(compoundKey, user);
	...
	public void should_remove() throws Exception {
		...
		assertThat(em.find(ClusteredEntityWithJoinEntity.class, compoundKey))
				.isNull();
	...
	public void should_refresh() throws Exception {
		...
		ClusteredEntityWithJoinEntity anotherEntity = em.find(
				ClusteredEntityWithJoinEntity.class, compoundKey);
	...
	public void should_query_with_default_params() throws Exception {
		long partitionKey = RandomUtils.nextLong();
		List<ClusteredEntityWithJoinEntity> entities = em
				.sliceQuery(ClusteredEntityWithJoinEntity.class)
	...
	public void should_iterate_with_default_params() throws Exception {
		...
		Iterator<ClusteredEntityWithJoinEntity> iter = em
				.sliceQuery(ClusteredEntityWithJoinEntity.class)
	...
	public void should_remove_with_default_params() throws Exception {
		...
		assertThat(entities.get(1).getFriend().getId()).isEqualTo(3L);
	}
	...
	private void insertClusteredEntity(Long partitionKey, String name,
		...
		ClusteredEntityWithJoinEntity entity = new ClusteredEntityWithJoinEntity(
				embeddedId, friend);
		em.persist(entity);
	}
