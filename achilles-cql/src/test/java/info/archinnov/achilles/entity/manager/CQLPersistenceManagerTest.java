...
public class CQLPersistenceManagerTest {
	...
	public void setUp() throws Exception {
		...
		Whitebox.setInternalState(manager, CQLEntityValidator.class, entityValidator);
		Whitebox.setInternalState(manager, CQLSliceQueryExecutor.class, sliceQueryExecutor);
		Whitebox.setInternalState(manager, CQLTypedQueryValidator.class, typedQueryValidator);
		Whitebox.setInternalState(manager, CQLPersistenceContextFactory.class, contextFactory);
	...
	public void should_return_slice_query_builder() throws Exception {
		...
		// Then
		assertThat(Whitebox.getInternalState(builder, CQLSliceQueryExecutor.class)).isSameAs(sliceQueryExecutor);
	...
	public void should_return_typed_query_builder() throws Exception {
		...
		assertThat(Whitebox.getInternalState(builder, EntityMeta.class)).isSameAs(meta);
		assertThat(Whitebox.getInternalState(builder, CQLPersistenceContextFactory.class)).isSameAs(contextFactory);
		assertThat(Whitebox.getInternalState(builder, String.class)).isEqualTo("querystring");
	}
