...
public class CQLEntityProxifierTest {
	...
	public void should_build_proxy() throws Exception {
		...
		assertThat(factory.getCallback(0)).isInstanceOf(CQLEntityInterceptor.class);
	}
	...
	public void should_get_interceptor_from_proxy() throws Exception {
		...
		CQLEntityInterceptor<CompleteBean> actual = proxifier.getInterceptor(proxy);
