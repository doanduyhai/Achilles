...
public class CQLTableBuilderTest {
	...
	@Test
	public void should_build_table_with_all_types_and_comment()
			throws Exception {

		String ddlScript = CQLTableBuilder.createTable("tableName")
	...
	public void should_build_counter_table_with_primary_keys() throws Exception {
		...
		String ddlScript = CQLTableBuilder.createCounterTable("tableName")
				.addColumn("longCol", Long.class)
				.addColumn("enumCol", PropertyType.class)
