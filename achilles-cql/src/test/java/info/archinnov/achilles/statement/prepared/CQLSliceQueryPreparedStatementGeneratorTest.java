...
public class CQLSliceQueryPreparedStatementGeneratorTest {
	...
	// /////////////////////// ASCENDING
	@Test
	public void should_generate_iterator_where_clause_for_ascending()
			throws Exception {
	...
	@Test
	public void should_generate_iterator_where_clause_with_no_end_for_ascending()
			throws Exception {
		when(sliceQuery.getAchillesOrdering()).thenReturn(ASCENDING);
		when(sliceQuery.getFixedComponents()).thenReturn(
				Arrays.<Object> asList(11L, uuid1, "author"));
	...
	// /////////////////////// DESCENDING
	@Test
	public void should_generate_iterator_where_clause_for_descending()
			throws Exception {
	...
	@Test
	public void should_generate_iterator_where_clause_with_no_end_for_descending()
			throws Exception {
		when(sliceQuery.getAchillesOrdering()).thenReturn(DESCENDING);
		when(sliceQuery.getFixedComponents()).thenReturn(
				Arrays.<Object> asList(11L, uuid1, "author"));
