...
@Table(table = "immutable_defaults_value")
public class ImmutableDefaultsEntity {
    ...
    public ImmutableDefaultsEntity() {
        throw new UnsupportedOperationException();
    }

    @EntityCreator
    public ImmutableDefaultsEntity(final long id, final Date date, final String value,
