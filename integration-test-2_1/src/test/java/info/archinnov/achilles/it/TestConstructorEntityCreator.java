...
public class TestConstructorEntityCreator {
    ...
    public void should_insert() throws Exception {
        ...
        final ImmutableEntity entity = newInstance(id, date);

        //When
        manager.crud().insert(entity).execute();

        //Then
        final List<Row> rows = session.execute("SELECT * FROM immutable_value WHERE id = " + id).all();
    ...
    public void should_insert_if_not_exists() throws Exception {
        ...
        scriptExecutor.executeScriptTemplate("ImmutableEntity/insert_single_row.cql", ImmutableMap.of("id", id, "table", "immutable_value"));
    ...
    public void should_insert_with_timestamp() throws Exception {
        ...
        //Then
        final Row row = session.execute("SELECT writetime(value) as wt FROM immutable_value WHERE id = " + id).one();
    ...
    public void should_insert_with_ttl() throws Exception {
        ...
        //Then
        final Row row = session.execute("SELECT * FROM immutable_value WHERE id = " + id).one();
    ...
    public void should_insert_generate_query_and_bound_values() throws Exception {
        ...
        final ImmutableEntity entity = new ImmutableEntity(id, date, "value", Arrays.asList(ALL), null, null);

        //When
        final InsertWithOptions<ImmutableEntity> insert = manager
                .crud()
                .insert(entity)
                .usingTimeToLive(123)
                .usingTimestamp(100L);
        ...
        String expectedQuery = "INSERT INTO " + DEFAULT_CASSANDRA_EMBEDDED_KEYSPACE_NAME + ".immutable_value (id,date,consistencylist,simplemap,simpleset,value) " +
    ...
    public void should_insert_with_downgrading_consistency() throws Exception {
        ...
        final long id = RandomUtils.nextLong(0L, Long.MAX_VALUE);
        final Date date = buildDateKey();
        final ImmutableEntity entity = new ImmutableEntity(id, date, "value", emptyList(), emptySet(), emptyMap());
    ...
    public void should_insert_with_insert_strategy_non_null_fields() throws Exception {
        ...
        final Date date = buildDateKey();
        scriptExecutor.executeScriptTemplate("ImmutableEntity/insert_single_row.cql", ImmutableMap.of("id", id, "table", "immutable_value"));
        final ImmutableEntity entity = new ImmutableEntity(id, date, null, emptyList(), emptySet(), emptyMap());
        ...
        //Then
        final Row row = session.execute("SELECT value FROM immutable_value WHERE id = " + id).one();
        assertThat(row).isNotNull();
    ...
    public void should_insert_with_schema_name_provider() throws Exception {
        ...
        scriptExecutor.executeScriptTemplate("ImmutableEntity/create_simple_mirror_table.cql", ImmutableMap.of("table", tableName));
        final long id = RandomUtils.nextLong(0L, Long.MAX_VALUE);
        final Date date = buildDateKey();
        final ImmutableEntity entity = new ImmutableEntity(id, date, "value_tenant3", emptyList(), emptySet(), emptyMap());
    ...
    public void should_find_by_id() throws Exception {
        ...
        //When
        final ImmutableEntity actual = manager.crud().findById(id, date).get();
    ...
    public void should_find_by_id_with_execution_info() throws Exception {
        ...
        //When
        final Tuple2<ImmutableEntity, ExecutionInfo> tuple2 = manager.crud().findById(id, date)
                .withConsistencyLevel(TWO)
                .withRetryPolicy(DowngradingConsistencyRetryPolicy.INSTANCE)
                .getWithStats();
    ...
    public void should_find_with_async_listeners() throws Exception {
        ...
        //When
        final ImmutableEntity found = manager
                .crud()
                .findById(id, date)
    ...
    public void should_find_with_schema_name_provider() throws Exception {
        ...
        scriptExecutor.executeScriptTemplate("ImmutableEntity/create_simple_mirror_table.cql", ImmutableMap.of("table", tableName));
        scriptExecutor.executeScriptTemplate("ImmutableEntity/insert_single_row.cql", ImmutableMap.of("id", id, "table", tableName));
        ...
        //When
        final ImmutableEntity actual = manager.crud().withSchemaNameProvider(provider).findById(id, date).get();
    ...
    public void should_delete_by_partition() throws Exception {
        //Given
        final long id = 200L;
        scriptExecutor.executeScriptTemplate("ImmutableEntity/insert_2_rows_same_partition.cql", ImmutableMap.of("id", id));
    ...
    public void should_delete_entity_generate_query_and_bound_values() throws Exception {
        ...
        final ImmutableEntity entity = new ImmutableEntity(id, date, "value", Arrays.asList(ALL), emptySet(), emptyMap());

        //When
        final DeleteWithOptions<ImmutableEntity> delete = manager
                .crud()
                .delete(entity)
                .usingTimestamp(100L);
        ...
        String expectedQuery = "DELETE FROM " + DEFAULT_CASSANDRA_EMBEDDED_KEYSPACE_NAME + ".immutable_value " +
    ...
    public void should_delete_by_partition_generate_query_and_bound_values() throws Exception {
        ...
        //When
        final DeleteByPartitionWithOptions<ImmutableEntity> delete = manager
                .crud()
    ...
    private ImmutableEntity newInstance(final long id, final Date date) {
