...
public class EntityPersister {
    ...
    protected <ID> void batchPersistSimpleProperty(Object entity, ID key, GenericDynamicCompositeDao<ID> dao,
        ...
        DynamicComposite name = dynamicCompositeKeyFactory.createForBatchInsertSingleValue(propertyMeta);
    ...
    public <ID> void batchPersistJoinEntity(Object entity, ID key, GenericDynamicCompositeDao<ID> dao,
        ...
        if (joinEntity != null) {
            ...
            if (joinId != null) {
                DynamicComposite joinName = dynamicCompositeKeyFactory.createForBatchInsertSingleValue(propertyMeta);
    ...
    protected <ID> void batchPersistSetProperty(Object entity, ID key, GenericDynamicCompositeDao<ID> dao,
        ...
        if (set != null) {
            for (Object value : set) {
                DynamicComposite name = dynamicCompositeKeyFactory.createForBatchInsertMultiValue(propertyMeta,
                        value.hashCode());
    ...
    protected <ID, K, V> void batchPersistMapProperty(Object entity, ID key, GenericDynamicCompositeDao<ID> dao,
        ...
        if (map != null) {
            for (Entry<K, V> entry : map.entrySet()) {
                DynamicComposite name = dynamicCompositeKeyFactory.createForBatchInsertMultiValue(propertyMeta, entry
                        .getKey().hashCode());
    ...
    @SuppressWarnings("unchecked")
    public <ID> void batchPersistCounter(Object entity, ID key, PropertyMeta<Void, Long> propertyMeta) {
        ...
        DynamicComposite comp = dynamicCompositeKeyFactory.createForBatchInsertSingleValue(propertyMeta);
        dao.insertCounter(keyComp, comp,
                propertyMeta.castValue(helper.getValueFromField(entity, propertyMeta.getGetter())),
    ...
    public <ID, V> void persistProperty(Object entity, ID key, GenericDynamicCompositeDao<ID> dao,
        ...
        switch (propertyMeta.type()) {
            ...
            case LAZY_SIMPLE:
                ...
                break;
            case COUNTER:
                this.batchPersistCounter(entity, key, (PropertyMeta<Void, Long>) propertyMeta);
                break;
            case LIST:
            case LAZY_LIST:
    ...
    public <ID, V> void removeProperty(ID key, GenericDynamicCompositeDao<ID> dao, PropertyMeta<?, V> propertyMeta) {
        ...
        DynamicComposite start = dynamicCompositeKeyFactory.createBaseForQuery(propertyMeta, ComponentEquality.EQUAL);
        DynamicComposite end = dynamicCompositeKeyFactory.createBaseForQuery(propertyMeta, GREATER_THAN_EQUAL);
