...
public class EntityPersister
{
	...
	public <ID> void persistCounter(Object entity, ID key, PropertyMeta<Void, Long> propertyMeta)
	{
		CounterDao dao = propertyMeta.getCounterProperties().getDao();
		String fqcn = propertyMeta.getCounterProperties().getFqcn();

		// Composite comp = compositeKeyFactory.createKeyForCounter(fqcn, key, idMeta);

		// dao.insertCounter(key, name, value)
		helper.getValueFromField(entity, propertyMeta.getGetter());
	}
