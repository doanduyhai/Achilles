 ...
 * 
 */
public class AchillesPropertyParsingValidator
{
	private static final Logger log = LoggerFactory
			.getLogger(AchillesPropertyParsingValidator.class);

	public void validateNoDuplicate(AchillesPropertyParsingContext context)
	{
	...
	public void validateWideRowHasNoExternalWideMap(AchillesPropertyParsingContext context)
	{
		log
				.debug("Validate that the wide map property {} for wide row {} has no external column family",
	...
	public void validateWideMapGenerics(AchillesPropertyParsingContext context)
	{
	...
	public void validateConsistencyLevelForCounter(AchillesPropertyParsingContext context,
			Pair<ConsistencyLevel, ConsistencyLevel> consistencyLevels)
	{
		log
				.debug("Validate that counter property {} of entity class {} does not have ANY consistency level",
						context.getCurrentPropertyName(), context
								.getCurrentEntityClass()
								.getCanonicalName());
