...
public abstract class AbstractWideMapWrapper<ID, K, V> implements WideMap<K, V> {
    ...
    public KeyValue<K, V> findFirstMatching(final K key) {
        List<KeyValue<K, V>> found = find(key, key, 1, BoundingMode.INCLUSIVE_BOUNDS, OrderingMode.ASCENDING);
    ...
    public KeyValue<K, V> findLastMatching(final K key) {
        List<KeyValue<K, V>> found = find(key, key, 1, BoundingMode.INCLUSIVE_BOUNDS, OrderingMode.DESCENDING);
    ...
    @Override
    public List<KeyValue<K, V>> find(final K start, final K end, final int count, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
    ...
    @Override
    public List<KeyValue<K, V>> find(final K start, final K end, final int count, final BoundingMode bounds,
    ...
    @Override
    public List<KeyValue<K, V>> findReverseBoundsExclusive(final K start, final K end, final int count) {
    ...
    public V findValue(final K key) {
        List<V> found = findValues(key, key, 1, BoundingMode.INCLUSIVE_BOUNDS, OrderingMode.ASCENDING);
    ...
    @Override
    public List<V> findValues(final K start, final K end, final int count, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
    ...
    @Override
    public List<V> findValues(final K start, final K end, final int count, final BoundingMode bounds,
            final OrderingMode ordering, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
        return reinitConsistencyLevel(new SafeExecutionContext<List<V>>() {
            @Override
    ...
    @Override
    public List<V> findReverseValues(final K start, final K end, final int count, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
        return reinitConsistencyLevel(new SafeExecutionContext<List<V>>() {
            @Override
            public List<V> execute() {
    ...
    @Override
    public List<K> findKeys(final K start, final K end, final int count, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
    ...
    @Override
    public List<K> findReverseKeys(final K start, final K end, final int count, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
        return reinitConsistencyLevel(new SafeExecutionContext<List<K>>() {
            @Override
            public List<K> execute() {
    ...
    @Override
    public KeyValueIterator<K, V> iterator(final K start, final K end, final int count, final BoundingMode bounds,
            final OrderingMode ordering, final ConsistencyLevel readLevel) {
        forceReadConsistencyLevel(readLevel);
        return reinitConsistencyLevel(new SafeExecutionContext<KeyValueIterator<K, V>>() {
            @Override
    ...
    @Override
    public KeyValueIterator<K, V> iteratorBoundsExclusive(final K start, final K end, final int count) {
    ...
    @Override
    public KeyValueIterator<K, V> iteratorReverseBoundsExclusive(final K start, final K end, final int count) {
    ...
    @Override
    public void remove(final K start, final K end, final BoundingMode bounds, final ConsistencyLevel writeLevel) {
        forceWriteConsistencyLevel(writeLevel);
        reinitConsistencyLevel(new SafeExecutionContext<Void>() {
            @Override
            public Void execute() {
