...
public class CounterKeyValueIterator<K> implements KeyValueIterator<K, Long> {
    ...
    private Iterator<HColumn<DynamicComposite, Long>> achillesSliceIterator;
    private PropertyMeta<K, Long> propertyMeta;

    public CounterKeyValueIterator(Iterator<HColumn<DynamicComposite, Long>> columnSliceIterator,
    ...
    public KeyValue<K, Long> next() {
        ...
        if (this.achillesSliceIterator.hasNext()) {
            HColumn<DynamicComposite, Long> column = this.achillesSliceIterator.next();
