 ...
 * 
 */
public class GenericMultiKeyWideRowDao<K> extends AbstractDao<K, Composite, Object>
{

	public GenericMultiKeyWideRowDao(Keyspace keyspace, Serializer<K> keySrz, String cf) {
		super(keyspace);
