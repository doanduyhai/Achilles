...
/**
 * This class is a copy of ColumnSliceIterator
 * 
 **/
public class CounterColumnSliceIterator<K, N> implements Iterator<HCounterColumn<N>> {
     ...
     *            Starting point of the range
     * @param finish
     *            Finish point of the range. Allows for a dynamically
     *            determined point
     * @param reversed
     *            Whether or not the columns should be reversed
     */
    public CounterColumnSliceIterator(SliceCounterQuery<K, N> query, N start, ColumnSliceFinish<N> finish,
            boolean reversed) {
        this(query, start, finish, reversed, DEFAULT_COUNT);
    }
    ...
    /**
     * When iterating over a CounterColumnSlice, it may be desirable to move the finish
