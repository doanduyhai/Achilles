...
public class IteratorFactory {
    public <K, V> KeyValueIteratorForWideRow<K, V> createKeyValueIteratorForWideRow(
            ColumnSliceIterator<?, Composite, Object> columnSliceIterator, PropertyMeta<K, V> wideMapMeta) {
    ...
    public <K, V> MultiKeyKeyValueIteratorForWideRow<K, V> createMultiKeyKeyValueIteratorForWideRow(
            ColumnSliceIterator<?, Composite, Object> columnSliceIterator, List<Method> componentSetters,
            MultiKeyWideMapMeta<K, V> multiKeyWideMapMeta) {
    ...
    public <K, V> KeyValueIteratorForEntity<K, V> createKeyValueIteratorForEntity(
            ColumnSliceIterator<?, DynamicComposite, ?> columnSliceIterator, Serializer<?> keySerializer,
            PropertyMeta<K, V> wideMapMeta) {
        return new KeyValueIteratorForEntity<K, V>((ColumnSliceIterator) columnSliceIterator, keySerializer,
                wideMapMeta);
    }

    public <K, V> MultiKeyKeyValueIteratorForEntity<K, V> createMultiKeyKeyValueIteratorForEntity(
            ColumnSliceIterator<?, DynamicComposite, Object> columnSliceIterator, List<Method> componentSetters,
            MultiKeyWideMapMeta<K, V> multiKeyWideMapMeta) {
        return new MultiKeyKeyValueIteratorForEntity<K, V>(columnSliceIterator, componentSetters, multiKeyWideMapMeta);
    }
