...
public class EntityPersister {
    ...
    private <ID extends Serializable> void batchSimpleProperty(Object entity, ID key, GenericDao<ID> dao,
            Mutator<ID> mutator, PropertyMeta<?> propertyMeta) {
    ...
    private <ID extends Serializable> void batchListProperty(Object entity, ID key, GenericDao<ID> dao,
            Mutator<ID> mutator, PropertyMeta<?> propertyMeta) {
    ...
    private <ID extends Serializable> void batchSetProperty(Object entity, ID key, GenericDao<ID> dao,
            Mutator<ID> mutator, PropertyMeta<?> propertyMeta) {
    ...
    private <ID extends Serializable> void batchMapProperty(Object entity, ID key, GenericDao<ID> dao,
            Mutator<ID> mutator, PropertyMeta<?> propertyMeta) {

        Map<?, ?> map = (Map<?, ?>) beanPropertyHelper.getValueFromField(entity, propertyMeta.getGetter());
        for (Entry<?, ?> entry : map.entrySet()) {

            Composite name = dao.buildCompositeForProperty(propertyMeta.getPropertyName(), MAP, entry.getKey()
                    .hashCode());
