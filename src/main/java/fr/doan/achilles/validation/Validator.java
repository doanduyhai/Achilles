...
public class Validator {
    ...
    public static void validateNotEmpty(Collection<?> arg, String label) {
        if (arg == null || arg.isEmpty()) {
            throw new ValidationException("The property '" + label + "' should not be null or empty");
        }
    }
    ...
    public static void validateSize(Collection<?> arg, int size, String label) {
        ...
        if (arg.size() != size) {
            throw new ValidationException("The collection property '" + label + "' should have exactly '" + size
                    + "' elements");
        }
    }
    ...
    public static void validateSize(Map<?, ?> arg, int size, String label) {
        validateNotEmpty(arg, label);
        if (arg.size() != size) {
            throw new ValidationException("The map property '" + label + "' should have exactly '" + size
                    + "' elements");
        }
    }
