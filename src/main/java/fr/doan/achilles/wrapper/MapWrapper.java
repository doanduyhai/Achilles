...
import static fr.doan.achilles.wrapper.builder.EntrySetWrapperBuilder.builder;
import static fr.doan.achilles.wrapper.builder.KeySetWrapperBuilder.builder;
import static fr.doan.achilles.wrapper.builder.ValueCollectionWrapperBuilder.builder;
