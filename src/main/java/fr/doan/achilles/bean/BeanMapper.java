...
public class BeanMapper {
    ...
    public <T extends Object, ID extends Serializable> void mapColumnsToBean(ID key,
            List<Pair<Composite, Object>> columns, EntityMeta<ID> entityMeta, T entity) {
    ...
    protected void addToMap(Map<String, Map> mapProperties, MapPropertyMeta<?> mapMeta, KeyValueHolder keyValueHolder) {
        ...
        map.put(keyValueHolder.getKey(), keyValueHolder.getValue());
    }
    ...
    public <T extends Object, ID extends Serializable> void mapSimplePropertyToBean(Object value,
            PropertyMeta<?> propertyMeta, T entity) {
        try {
            propertyMeta.getSetter().invoke(entity, value);
        } catch (Exception e) {
            throw new BeanMappingException("Cannot set value '" + value + "' to entity " + entity, e);
        }
    }

    public <T extends Object, ID extends Serializable> void mapListPropertyToBean(List<?> list,
            PropertyMeta<?> listMeta, T entity) {
        try {
    ...
    public <T extends Object, ID extends Serializable> void mapSetPropertyToBean(Set<?> set, PropertyMeta<?> setMeta,
            T entity) {
        try {
    ...
    public <T extends Object, ID extends Serializable> void mapMapPropertyToBean(Map<?, ?> map,
            PropertyMeta<?> mapMeta, T entity) {
        try {
