...
public class ThriftEntityManagerOperationsIT {
    ...
    public void should_remove() throws Exception {
        ...
        List<Pair<DynamicComposite, Object>> columns = dao.findColumnsRange(bean.getId(), null, null, false, 20);
    ...
    public void should_refresh() throws Exception {
        ...
        DynamicComposite friend3Composite = keyFactory.createForInsert("friends", PropertyType.LAZY_LIST, 2);
