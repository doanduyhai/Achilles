...
public class PropertyMetaTestBuilder<T, K, V> {
    ...
    public static <K, V> PropertyMetaTestBuilder<CompleteBean, K, V> completeBean(Class<K> keyClass,
            Class<V> valueClass) {
        return new PropertyMetaTestBuilder<CompleteBean, K, V>(CompleteBean.class, keyClass, valueClass);
    }

    public static <K, V> PropertyMetaTestBuilder<Void, K, V> noClass(Class<K> keyClass, Class<V> valueClass) {
    ...
    public PropertyMeta<K, V> build() throws Exception {
        ...
        propertyMeta.setKeySerializer((Serializer<K>) SerializerTypeInferer.getSerializer(keyClass));
        propertyMeta.setValueSerializer((Serializer<V>) SerializerTypeInferer.getSerializer(valueClass));
        ...
        if (counterIdMeta != null || counterDao != null || fqcn != null) {
            CounterProperties counterProperties = new CounterProperties(fqcn, counterDao, counterIdMeta);
