...
public class AchillesEntrySetWrapperTest
{
	@Mock
	...
	public void should_mark_dirty_on_clear() throws Exception
	{
		...
		AchillesEntrySetWrapper<Integer, String> wrapper = prepareWrapper(map);
	...
	{
		AchillesEntrySetWrapper<Integer, String> wrapper = prepareWrapper(new HashMap<Integer, String>());
	...
	public void should_return_array_when_join() throws Exception
	{
		...
		assertThat(array).hasSize(1);
		assertThat(array[0]).isInstanceOf(AchillesMapEntryWrapper.class);
	}
	...
	public void should_return_array_with_argument_when_join_entity() throws Exception
	{
		...
		AchillesEntrySetWrapper<Integer, CompleteBean> wrapper = prepareJoinWrapper(map);
	...
	private AchillesEntrySetWrapper<Integer, String> prepareWrapper(Map<Integer, String> map)
	{
		AchillesEntrySetWrapper<Integer, String> wrapper = new AchillesEntrySetWrapper<Integer, String>(
				map.entrySet());
	...
	private AchillesEntrySetWrapper<Integer, CompleteBean> prepareJoinWrapper(
			Map<Integer, CompleteBean> map)
	{
		AchillesEntrySetWrapper<Integer, CompleteBean> wrapper = new AchillesEntrySetWrapper<Integer, CompleteBean>(
				map.entrySet());
		wrapper.setContext(context);
		wrapper.setDirtyMap(dirtyMap);
		wrapper.setSetter(setter);
