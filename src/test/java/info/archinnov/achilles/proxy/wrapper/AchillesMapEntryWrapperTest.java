...
public class AchillesMapEntryWrapperTest
{
	@Mock
	...
	public void should_mark_dirty_on_value_set() throws Exception
	{
		...
		AchillesMapEntryWrapper<Integer, String> mapEntryWrapper = new AchillesMapEntryWrapper<Integer, String>(
				mapEntry);
	...
	public void should_equal() throws Exception
	{
		...
		AchillesMapEntryWrapper<Integer, String> wrapper1 = new AchillesMapEntryWrapper<Integer, String>(
				entry1);
		AchillesMapEntryWrapper<Integer, String> wrapper2 = new AchillesMapEntryWrapper<Integer, String>(
				entry2);
