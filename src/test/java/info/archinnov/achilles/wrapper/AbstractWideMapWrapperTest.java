...
public class AbstractWideMapWrapperTest {
    ...
    private AbstractWideMapWrapper<Long, Long, String> wrapper = new AbstractWideMapWrapper<Long, Long, String>() {
        ...
        @Override
        public KeyValueIterator<Long, String> iterator(Long start, Long end, int count, BoundingMode bounds,
        ...
        @Override
        public List<KeyValue<Long, String>> find(Long start, Long end, int count, BoundingMode bounds,
                OrderingMode ordering) {
            StateCapture capture = new StateCapture();
            capture.start = start;
            capture.end = end;
        ...
        @Override
        public List<String> findValues(Long start, Long end, int count, BoundingMode bounds, OrderingMode ordering) {
            StateCapture capture = new StateCapture();
            capture.start = null;
            capture.end = null;
            capture.inclusiveStart = true;
        ...
        @Override
        public List<Long> findKeys(Long start, Long end, int count, BoundingMode bounds, OrderingMode ordering) {
            StateCapture capture = new StateCapture();
            capture.start = null;
            capture.end = null;
            capture.inclusiveStart = true;
        ...
        @Override
        public void insert(final Long key, final String value, final int ttl, final ConsistencyLevel writeLevel) {
        ...
        @Override
        public KeyValue<Long, String> findFirstMatching(final Long key, final ConsistencyLevel readLevel) {
            StateCapture capture = new StateCapture();
            capture.readLevel = readLevel;
            stateCapture.set(capture);
        ...
        @Override
        public KeyValue<Long, String> findLastMatching(final Long key, final ConsistencyLevel readLevel) {
            StateCapture capture = new StateCapture();
            capture.readLevel = readLevel;
            stateCapture.set(capture);
        ...
        @Override
        public List<KeyValue<Long, String>> findBoundsExclusive(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<KeyValue<Long, String>> findReverse(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<KeyValue<Long, String>> findReverseBoundsExclusive(final Long start, final Long end,
        ...
        @Override
        public List<KeyValue<Long, String>> findFirst(final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<KeyValue<Long, String>> findLast(final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<String> findValues(final Long start, final Long end, final int count, final BoundingMode bounds,
        ...
        @Override
        public List<String> findBoundsExclusiveValues(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<String> findReverseBoundsExclusiveValues(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<Long> findKeys(final Long start, final Long end, final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<Long> findKeys(final Long start, final Long end, final int count, final BoundingMode bounds,
                final OrderingMode ordering, final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<Long> findBoundsExclusiveKeys(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public List<Long> findReverseBoundsExclusiveKeys(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public KeyValueIterator<Long, String> iterator(final Long start, final Long end, final int count,
                final BoundingMode bounds, final OrderingMode ordering, final ConsistencyLevel readLevel) {
            StateCapture capture = new StateCapture();
            capture.readLevel = readLevel;
            stateCapture.set(capture);
        ...
        @Override
        public KeyValueIterator<Long, String> iterator(final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public KeyValueIterator<Long, String> iteratorBoundsExclusive(final Long start, final Long end,
                final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public KeyValueIterator<Long, String> iteratorReverse(final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public KeyValueIterator<Long, String> iteratorReverse(final Long start, final Long end, final int count,
                final ConsistencyLevel readLevel) {
        ...
        @Override
        public KeyValueIterator<Long, String> iteratorReverseBoundsExclusive(final Long start, final Long end,
                final int count, final ConsistencyLevel readLevel) {
        ...
        @Override
        public void removeBoundsExclusive(final Long start, final Long end, final ConsistencyLevel writeLevel) {
