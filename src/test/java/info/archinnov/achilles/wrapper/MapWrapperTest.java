...
public class MapWrapperTest
{
	...
	private MapWrapper<Integer, UserBean> prepareJoinMapWrapper(Map<Integer, UserBean> target)
	{
		MapWrapper<Integer, UserBean> wrapper = new MapWrapper<Integer, UserBean>(target);
