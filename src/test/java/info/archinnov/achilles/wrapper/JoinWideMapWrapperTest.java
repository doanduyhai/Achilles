...
public class JoinWideMapWrapperTest
{
	...
	@InjectMocks
	private JoinWideMapWrapper<Integer, CompleteBean> wrapper;
	...
	public void should_get_iterator() throws Exception
	{
		...
		AchillesJoinSliceIterator<Long, Integer, CompleteBean> iterator = mock(AchillesJoinSliceIterator.class);
