...
public class KeyValueFactoryTest {
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(factory, "dynamicCompositeTransformer", dynamicCompositeTransformer);
    ...
    public void should_create_keyvalue_from_dynamic_composite_hcolumn() throws Exception {
        ...
        when(dynamicCompositeTransformer.buildKeyValueFromDynamicComposite(wideMapMeta, hColumn))
                .thenReturn(keyValue);
        KeyValue<Integer, String> built = factory.createKeyValueForDynamicComposite(wideMapMeta, hColumn);
    ...
    public void should_create_key_from_dynamic_composite_hcolumn() throws Exception {
        ...
        Integer key = 123;
        when(dynamicCompositeTransformer.buildKeyFromDynamicComposite(wideMapMeta, hColumn)).thenReturn(key);
    ...
    public void should_create_value_from_dynamic_composite_hcolumn() throws Exception {
        ...
        when(dynamicCompositeTransformer.buildValueFromDynamicComposite(wideMapMeta, hColumn)).thenReturn(value);
    ...
    public void should_create_value_list_for_dynamic_composite() throws Exception {
        ...
        List<String> builtList = factory.createValueListForDynamicComposite(wideMapMeta, Arrays.asList(hCol1, hCol2));
    ...
    public void should_create_join_value_list_for_dynamic_composite() throws Exception {
        ...
        PropertyMeta<Integer, UserBean> propertyMeta = noClass(Integer.class, UserBean.class).joinMeta(joinMeta)
                .build();

        DynamicComposite dynComp1 = CompositeTestBuilder.builder().buildDynamic();
        DynamicComposite dynComp2 = CompositeTestBuilder.builder().buildDynamic();
        HColumn<DynamicComposite, String> hCol1 = HColumnTestBuilder.dynamic(dynComp1, joinId1.toString());
        HColumn<DynamicComposite, String> hCol2 = HColumnTestBuilder.dynamic(dynComp2, joinId2.toString());
        ...
        when(dynamicCompositeTransformer.buildRawValueTransformer(propertyMeta)).thenReturn(rawValueFn);
        Map<Long, UserBean> map = new HashMap<Long, UserBean>();
        map.put(joinId1, bean1);
        map.put(joinId2, bean2);

        when(joinHelper.loadJoinEntities(eq(UserBean.class), joinIdsCaptor.capture(), eq(joinMeta))).thenReturn(map);
    ...
    public void should_create_key_list_for_dynamic_composite() throws Exception {
        ...
        when((Function) dynamicCompositeTransformer.buildKeyTransformer(wideMapMeta)).thenReturn(function);

        List<Integer> builtList = factory.createKeyListForDynamicComposite(wideMapMeta, Arrays.asList(hCol1, hCol2));
    ...
    public void should_create_keyvalue_list_for_dynamic_composite() throws Exception {
        ...
        when(dynamicCompositeTransformer.buildKeyValueTransformer(wideMapMeta)).thenReturn(function);

        List<KeyValue<Integer, String>> builtList = factory.createKeyValueListForDynamicComposite(wideMapMeta,
                Arrays.asList(hCol1, hCol2));
    ...
    public void should_create_join_key_value_list_for_dynamic_composite() throws Exception {
        ...
        DynamicComposite dynComp1 = CompositeTestBuilder.builder().values(0, 1, key1).buildDynamic();
        DynamicComposite dynComp2 = CompositeTestBuilder.builder().values(0, 1, key2).buildDynamic();
        HColumn<DynamicComposite, String> hCol1 = HColumnTestBuilder.dynamic(dynComp1, joinId1.toString(), ttl1);
        HColumn<DynamicComposite, String> hCol2 = HColumnTestBuilder.dynamic(dynComp2, joinId2.toString(), ttl2);
        ...
        when((Function) dynamicCompositeTransformer.buildKeyTransformer(propertyMeta)).thenReturn(keyFunction);
        when(dynamicCompositeTransformer.buildRawValueTransformer(propertyMeta)).thenReturn(rawValueFn);
        ...
        List<KeyValue<Integer, UserBean>> builtList = factory.createJoinKeyValueListForDynamicComposite(propertyMeta,
                Arrays.asList(hCol1, hCol2));
    ...
    public void should_create_keyvalue_from_composite_hcolumn() throws Exception {
        ...
        KeyValue<Integer, String> keyValue = new KeyValue<Integer, String>(12, "test");
        when(compositeTransformer.buildKeyValueFromComposite(wideMapMeta, hColumn)).thenReturn(keyValue);
    ...
    public void should_create_keyvalue_list_for_composite() throws Exception {
        ...
        when(compositeTransformer.buildKeyValueTransformer(wideMapMeta)).thenReturn((Function) function);

        List<KeyValue<Integer, String>> builtList = factory.createKeyValueListForComposite(wideMapMeta,
                Arrays.asList((HColumn<Composite, ?>) hCol1, hCol2));
    ...
    public void should_create_join_keyvalue_list_for_composite() throws Exception {
        ...
        when(helper.buildProxy(bean1, joinMeta)).thenReturn(bean1);
        when(helper.buildProxy(bean2, joinMeta)).thenReturn(bean2);
        List<KeyValue<Integer, UserBean>> builtList = factory.createJoinKeyValueListForComposite(propertyMeta,
                Arrays.asList((HColumn<Composite, ?>) hCol1, hCol2));
