...
public class ColumnFamilyHelperTest {
    ...
    public void should_build_dynamic_composite_column_family() throws Exception {
        ...
        ColumnFamilyDefinition cfDef = columnFamilyHelper.buildDynamicCompositeCF(entityMeta, "keyspace");
    ...
    public void should_build_composite_column_family() throws Exception {
        ...
        when(helper.determineCompatatorTypeAliasForCompositeCF(wideMapMeta, true)).thenReturn("typeAlias");

        ColumnFamilyDefinition cfDef = columnFamilyHelper.buildCompositeCF("keyspace", wideMapMeta, Long.class, "cf",
                "entity");
    ...
    public void should_build_counter_column_family() throws Exception {
        ...
        assertThat(cfDef.getDefaultValidationClass()).isEqualTo(LONGTYPE.getTypeName());
    ...
    public void should_exception_when_wrong_validation_class_on_counter_column_family() throws Exception {
        ...
        exception.expect(InvalidColumnFamilyException.class);
        exception
                .expectMessage("The column family 'achillesCounterCF' validation class 'org.apache.cassandra.db.marshal.AsciiType' should be 'org.apache.cassandra.db.marshal.LongType'");
    ...
    public void should_validate_counter_cf() throws Exception {
        when(cfDef.getKeyValidationClass()).thenReturn(COMPOSITETYPE.getClassName());
        when(cfDef.getComparatorType()).thenReturn(DYNAMICCOMPOSITETYPE);
        when(cfDef.getDefaultValidationClass()).thenReturn(LONGTYPE.getClassName());
    ...
    public void should_validate_column_family_direct_mapping() throws Exception {
        ...
        Map<String, PropertyMeta<Long, String>> propertyMetaMap = ImmutableMap.of("any", propertyMeta);
    ...
    @SuppressWarnings("rawtypes")
    @Test
    public void should_exception_when_composite_type_alias_when_cf_direct_mapping_not_match() throws Exception {
        when(cfDef.getKeyValidationClass()).thenReturn(LONG_SRZ.getComparatorType().getClassName());
        when(entityMeta.getIdSerializer()).thenReturn(LONG_SRZ);
        when(entityMeta.getColumnFamilyName()).thenReturn("cf");
        when(entityMeta.isColumnFamilyDirectMapping()).thenReturn(true);
        ...
        exception.expect(InvalidColumnFamilyException.class);
        exception.expectMessage("The column family 'cf' comparator type should be 'CounterColumnType'");
