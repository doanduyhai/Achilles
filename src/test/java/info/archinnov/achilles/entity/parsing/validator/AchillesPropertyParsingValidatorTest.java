...
public class AchillesPropertyParsingValidatorTest
{
	@Rule
	...
	@Mock
	private AchillesPropertyParsingContext context;
	...
	@SuppressWarnings("unchecked")
	@Test
	public void should_exception_when_widemmap_not_parameterized() throws Exception
	{
		class Test
		{
			@SuppressWarnings(
		...
		exception.expect(AchillesBeanMappingException.class);
		exception.expectMessage("The WideMap type should be parameterized for the entity '"
				+ Test.class.getCanonicalName() + "'");
	...
	public void should_exception_when_type_not_allowed() throws Exception
	{
		...
		AchillesPropertyParsingValidator.validateAllowedTypes(Integer.class, allowedTypes, "msg1");

		AchillesPropertyParsingValidator.validateAllowedTypes(CorrectMultiKey.class, allowedTypes,
				"msg1");
		AchillesPropertyParsingValidator.validateAllowedTypes(CustomEnum.class, allowedTypes,
				"msg1");
	}
