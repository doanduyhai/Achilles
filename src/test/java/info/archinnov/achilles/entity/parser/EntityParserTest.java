...
public class EntityParserTest {
    ...
    public void should_parse_entity() throws Exception {
        ...
        assertThat((Serializer) linkedUsers.getValueSerializer()).isEqualTo(SerializerUtils.OBJECT_SRZ);
        assertThat(linkedUsers.type()).isEqualTo(JOIN_WIDE_MAP);
        assertThat(linkedUsers.getJoinProperties().getCascadeTypes()).containsExactly(PERSIST, MERGE);
    ...
    public void should_parse_bean_with_external_wide_map() throws Exception {
        ...
        ExternalWideMapProperties<?> externalWideMapProperties = usersPropertyMeta.getExternalWideMapProperties();

        assertThat(externalWideMapProperties.getExternalColumnFamilyName()).isEqualTo("external_users");
    ...
    public void should_parse_bean_with_external_join_wide_map() throws Exception {
        ...
        assertThat((Class) joinPropertyMetaToBeFilled.get(usersPropertyMeta)).isEqualTo(UserBean.class);
    }
    ...
    public void should_parse_column_family_with_join() throws Exception {
        ...
        ExternalWideMapProperties<?> externalWideMapProperties = friendMeta.getExternalWideMapProperties();

        assertThat(externalWideMapProperties).isNotNull();
        assertThat(externalWideMapProperties.getExternalColumnFamilyName()).isEqualTo(
                ColumnFamilyHelper.normalizerAndValidateColumnFamilyName(ColumnFamilyBeanWithJoinEntity.class
                        .getName()));
        assertThat(externalWideMapProperties.getExternalWideMapDao()).isNull();
    ...
    public void should_fill_join_entity_meta_map_with_entity_meta() throws Exception {
        ...
        assertThat((EntityMeta<Long>) joinPropertyMeta.getJoinProperties().getEntityMeta()).isSameAs(joinEntityMeta);
    }
    ...
    public void should_fill_join_entity_meta_map_with_entity_meta_for_external() throws Exception {
        ...
        ExternalWideMapProperties<Long> externalWideMapProperties = new ExternalWideMapProperties<Long>("cfExternal",
                dao, LONG_SRZ);
        ...
        GenericCompositeDao<?, ?> externalWideMapDao = joinPropertyMeta.getExternalWideMapProperties()
        ...
        assertThat(Whitebox.getInternalState(externalWideMapDao, "keySerializer")).isSameAs(LONG_SRZ);
        assertThat(Whitebox.getInternalState(externalWideMapDao, "columnFamily")).isSameAs("cfExternal");
        assertThat(Whitebox.getInternalState(externalWideMapDao, "valueSerializer")).isSameAs(LONG_SRZ);
    }
