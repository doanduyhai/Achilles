...
public class PropertyParserTest {
    ...
    public void should_parse_list() throws Exception {
        ...
        assertThat((Serializer<String>) meta.getValueSerializer()).isEqualTo(SerializerUtils.STRING_SRZ);
    ...
    public void should_parse_set() throws Exception {
        ...
        assertThat((Serializer<Long>) meta.getValueSerializer()).isEqualTo(SerializerUtils.LONG_SRZ);
    ...
    public void should_parse_map() throws Exception {
        ...
        assertThat((Serializer<Integer>) meta.getKeySerializer()).isEqualTo(SerializerUtils.INT_SRZ);
    }
    ...
    public void should_parse_wide_map() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("tweets"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_exception_when_no_external_cf_defined_for_widemap() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("wideMap"));
    ...
    public void should_parse_counter_widemap() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("counters"));
    ...
    public void should_exception_when_no_external_cf_defined_for_counter_widemap() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("counterWideMap"));
    ...
    public void should_exception_when_wide_row_has_external_wide_map() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("external"));
    ...
    public void should_fill_join_widemap_hashmap() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("beans"));
    ...
    public void should_parse_multi_key_wide_map() throws Exception {
        ...
        assertThat((Serializer<String>) multiKeyProperties.getComponentSerializers().get(0)).isEqualTo(
                SerializerUtils.STRING_SRZ);
        assertThat((Serializer<Integer>) multiKeyProperties.getComponentSerializers().get(1)).isEqualTo(
    ...
    public void should_exception_when_field_not_serializable() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("parser"));
    ...
    public void should_exception_when_value_of_list_not_serializable() throws Exception {
        ...
        PropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("parsers"));
