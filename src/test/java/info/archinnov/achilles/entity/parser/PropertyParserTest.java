...
public class PropertyParserTest {
    ...
    public void should_parse_external_widemap() throws Exception {
        ...
        assertThat(externalProps.getExternalWideMapDao().getColumnFamily()).isEqualTo("externalTableName");
        assertThat(Whitebox.getInternalState(externalProps.getExternalWideMapDao(), "valueSerializer")).isEqualTo(
                UUID_SRZ);

        assertThat(propertyMetas).hasSize(1);
        PropertyMeta<Long, UUID> meta = (PropertyMeta<Long, UUID>) propertyMetas.values().iterator().next();
    ...
    public void should_parse_external_widemap_with_non_primitive_value() throws Exception {
        ...
        assertThat(
                Whitebox.getInternalState(propertyMeta.getExternalWideMapProperties().getExternalWideMapDao(),
                        "valueSerializer")).isEqualTo(STRING_SRZ);
    }
