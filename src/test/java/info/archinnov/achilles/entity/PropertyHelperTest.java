...
public class PropertyHelperTest {
    ...
    public void should_exception_when_multi_key_incorrect_type() throws Exception {
        ...
        expectedEx.expectMessage("The class 'java.util.List' is not a valid key type for the MultiKey class '"
    ...
    public void should_determine_composite_type_alias_for_column_family() throws Exception {
        ...
        String compatatorTypeAlias = helper.determineCompatatorTypeAliasForCompositeCF(propertyMeta, true);
    ...
    public void should_determine_composite_type_alias_for_column_family_check() throws Exception {
        ...
        String compatatorTypeAlias = helper.determineCompatatorTypeAliasForCompositeCF(propertyMeta, false);
    ...
    public void should_build_multikey_for_composite() throws Exception {
        ...
        Method retweetCountSetter = TweetMultiKey.class.getDeclaredMethod("setRetweetCount", int.class);
        ...
        HColumn<Composite, String> hCol1 = buildHColumn(buildComposite("author1", uuid1, 11), "val1");
        ...
        TweetMultiKey multiKey = helper.buildMultiKeyFromComposite(multiKeyWideMeta, hCol1.getName().getComponents());
