...
public class BeanPropertyHelperTest {
    ...
    public void should_find_accessors() throws Exception {
        ...
        Method[] accessors = helper
                .findAccessors(Bean.class, Bean.class.getDeclaredField("ComplicatedAttributeName"));
    ...
    public void should_get_key() throws Exception {
        ...
        Method[] accessors = helper
                .findAccessors(Bean.class, Bean.class.getDeclaredField("ComplicatedAttributeName"));
        PropertyMeta<String> idMeta = simplePropertyMetaBuilder(String.class)
