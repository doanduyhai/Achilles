...
public class PropertyParserTest {
    ...
    public void should_parse_simple_property_string() throws Exception {
        ...
        PropertyMeta<Void, String> meta = parser.parse(Test.class, Test.class.getDeclaredField("name"), "name");
    ...
    public void should_parse_simple_property_and_override_name() throws Exception {
        ...
        PropertyMeta<Void, String> meta = parser.parse(Test.class, Test.class.getDeclaredField("name"), "firstname");
    ...
    public void should_parse_simple_join_property() throws Exception {
        ...
        PropertyMeta<Void, UserBean> meta = parser.parse(Test.class, Test.class.getDeclaredField("user"), "user");
    ...
    @Test
    public void should_exception_when_simple_join_property_has_incorrect_annotation() throws Exception {
        class Test {
        ...
        expectedEx.expectMessage("Incorrect annotation. Only @ManyToOne is allowed for the join property 'user'");
    ...
    @Test
    public void should_exception_when_missing_ManyToOne_annotation_fot_simple_join_property() throws Exception {
        class Test {
            @JoinColumn
            private UserBean user;
    ...
    public void should_parse_lazy() throws Exception {
        ...
        PropertyMeta<Void, String> meta = parser.parse(Test.class, Test.class.getDeclaredField("friends"), "friends");
    ...
    public void should_parse_set() throws Exception {
        ...
        PropertyMeta<Void, Long> meta = parser.parse(Test.class, Test.class.getDeclaredField("followers"),
                "followers");
    ...
    public void should_parse_map() throws Exception {
        ...
        PropertyMeta<Integer, String> meta = parser.parse(Test.class, Test.class.getDeclaredField("preferences"),
                "preferences");
    ...
    public void should_parse_wide_map() throws Exception {
        ...
        PropertyMeta<UUID, String> meta = parser.parse(Test.class, Test.class.getDeclaredField("tweets"), "tweets");
    ...
    public void should_parse_multi_key_wide_map() throws Exception {
        ...
        PropertyMeta<CorrectMultiKey, String> meta = parser.parse(Test.class, Test.class.getDeclaredField("tweets"),
                "tweets");
        ...
        assertThat((Serializer) multiKeyProperties.getComponentSerializers().get(0)).isEqualTo(Utils.STRING_SRZ);
        assertThat((Serializer) multiKeyProperties.getComponentSerializers().get(1)).isEqualTo(Utils.INT_SRZ);
    }
    ...
    public void should_parse_join_wide_map() throws Exception {
        ...
        PropertyMeta<UUID, UserBean> meta = parser.parse(Test.class, Test.class.getDeclaredField("users"), "users");
    ...
    public void should_exception_when_join_wide_map_has_incorrect_annotation() throws Exception {
        ...
        expectedEx.expect(BeanMappingException.class);
        expectedEx.expectMessage("Incorrect annotation. Only @ManyToMany is allowed for the join property 'users'");
    ...
    @Test
    public void should_exception_when_missing_ManyToMany_annotation_for_join_wide_map() throws Exception {
        class Test {
            @JoinColumn
            private WideMap<UUID, UserBean> users;
