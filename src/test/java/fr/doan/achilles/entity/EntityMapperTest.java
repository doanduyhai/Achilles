...
public class EntityMapperTest {
    ...
    public void should_map_list_property() throws Exception {
        CompleteBean entity = new CompleteBean();
        mapper.mapListPropertyToBean(Arrays.asList("foo", "bar"), entityMeta.getPropertyMetas().get("friends"),
                entity);
    ...
    public void should_map_set_property() throws Exception {
        CompleteBean entity = new CompleteBean();
        mapper.mapSetPropertyToBean(Sets.newHashSet("George", "Paul"),
                entityMeta.getPropertyMetas().get("followers"), entity);
    ...
    public void should_map_columns_to_bean() throws Exception {
        ...
        columns.add(new Pair<Composite, Object>(buildMapPropertyComposite("preferences"), new KeyValueHolder(2,
                "Paris")));
        columns.add(new Pair<Composite, Object>(buildMapPropertyComposite("preferences"), new KeyValueHolder(3,
                "75014")));
