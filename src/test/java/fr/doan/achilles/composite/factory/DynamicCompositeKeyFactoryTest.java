...
public class DynamicCompositeKeyFactoryTest {
    ...
    public void should_create_for_query_with_null_value() throws Exception {
        DynamicComposite comp = keyFactory.createForQuery("friends", PropertyType.LIST, null, LESS_THAN_EQUAL);
    ...
    public void should_create_for_query_without_value() throws Exception {
        DynamicComposite comp = keyFactory.createBaseForQuery("friends", PropertyType.LIST, GREATER_THAN_EQUAL);
    ...
    public void should_create_for_query_with_value() throws Exception {
        ...
        DynamicComposite comp = keyFactory.createForQuery("friends", PropertyType.LIST, list, GREATER_THAN_EQUAL);
    ...
    public void should_create_for_multikey_insert() throws Exception {
        ...
        DynamicComposite comp = keyFactory.createForInsertMultiKey("property", WIDE_MAP, keyValues, serializers);
    ...
    public void should_create_for_multikey_query() throws Exception {
        ...
        DynamicComposite comp = keyFactory.createForQueryMultiKey("property", WIDE_MAP, keyValues, serializers,
                LESS_THAN_EQUAL);
    ...
    public void should_create_pair_for_query() throws Exception {
        ...
        DynamicComposite[] composites = keyFactory.createForQuery("property", WIDE_MAP, 12L, inclusiveStart, 15L,
