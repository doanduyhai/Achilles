...
public class EntryIteratorProxyBuilderTest
{
	@Mock
	...
	public void should_build() throws Exception
	{
		...
		EntryIteratorProxy<Integer, String> iteratorProxy = EntryIteratorProxyBuilder.builder(map.entrySet().iterator()).dirtyMap(dirtyMap)
