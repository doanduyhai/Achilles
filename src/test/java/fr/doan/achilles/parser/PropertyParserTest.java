...
public class PropertyParserTest {
    ...
    public void should_parse_simple_property_string() throws Exception {
        ...
        assertThat(meta.getGetter().getReturnType()).isEqualTo(String.class);
        assertThat(meta.getSetter().getName()).isEqualTo("setName");
        assertThat(meta.getSetter().getParameterTypes()[0]).isEqualTo(String.class);
    ...
    public void should_parse_list() throws Exception {
        ...
        assertThat(meta.getGetter().getReturnType()).isEqualTo(List.class);
        assertThat(meta.getSetter().getName()).isEqualTo("setFriends");
        assertThat(meta.getSetter().getParameterTypes()[0]).isEqualTo(List.class);
    ...
    public void should_parse_set() throws Exception {
        ...
        assertThat(meta.getGetter().getReturnType()).isEqualTo(Set.class);
        assertThat(meta.getSetter().getName()).isEqualTo("setFollowers");
        assertThat(meta.getSetter().getParameterTypes()[0]).isEqualTo(Set.class);
    ...
    public void should_parse_map() throws Exception {
        ...
        PropertyMeta<String> meta = parser.parse(Test.class, Test.class.getDeclaredField("preferences"),
                "preferences");
        ...
        assertThat(meta.getGetter().getReturnType()).isEqualTo(Map.class);
        assertThat(meta.getSetter().getName()).isEqualTo("setPreferences");
        assertThat(meta.getSetter().getParameterTypes()[0]).isEqualTo(Map.class);

        assertThat(mapMeta.getKeySerializer()).isEqualTo(Utils.INT_SRZ);
    }
