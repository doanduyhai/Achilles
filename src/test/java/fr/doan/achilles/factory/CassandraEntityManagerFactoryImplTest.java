...
{
	@InjectMocks
	private CassandraEntityManagerFactoryImpl factory = new CassandraEntityManagerFactoryImpl();
	...
	@Mock
	private EntityMeta<Serializable> meta;
	...
	public void should_bootstrap() throws Exception
	{
		...
		when(entityParser.parseEntity(Long.class)).thenReturn(meta);
		when(entityParser.parseEntity(String.class)).thenReturn(meta);
	...
	public void should_testname() throws Exception
	{
		...
		assertThat(Test.class.getDeclaredField("age").getType().isPrimitive()).isTrue();
