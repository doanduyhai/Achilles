...
public class ListPropertyMetaBuilderTest {
    ...
    public void should_build_list_property_meta() throws Exception {
        ...
        ListPropertyMeta<String> meta = (ListPropertyMeta<String>) listPropertyMetaBuilder(String.class)
                .listClass(ArrayList.class).propertyName("friends").accessors(accessors).build();
