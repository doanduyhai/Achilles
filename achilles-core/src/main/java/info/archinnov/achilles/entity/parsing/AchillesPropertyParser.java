...
import static info.archinnov.achilles.helper.AchillesPropertyHelper.allowedTypes;
...
public class AchillesPropertyParser
{
	...
	public PropertyMeta<Void, ?> parseSimpleProperty(AchillesPropertyParsingContext context)
	{
	...
	public PropertyMeta<Void, ?> parseCounterProperty(AchillesPropertyParsingContext context)
	{
	...
	public <K, V> PropertyMeta<K, V> parseMapProperty(AchillesPropertyParsingContext context)
	{
	...
	public <K, V> PropertyMeta<K, V> parseWideMapProperty(AchillesPropertyParsingContext context)
	{
			...
			Class<?> keyClass)
	{
		...
		{
			AchillesPropertyParsingValidator
	...
	private void saveWideMapForDeferredBinding(AchillesPropertyParsingContext context,
			PropertyMeta<?, ?> propertyMeta)
	{
