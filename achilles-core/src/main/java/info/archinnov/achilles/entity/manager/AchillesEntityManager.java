 ...
 * 
 */
public abstract class AchillesEntityManager<CONTEXT extends AchillesPersistenceContext> implements EntityManager {
    ...
    protected EntityMerger<CONTEXT> merger;
    protected EntityRefresher<CONTEXT> refresher;
    ...
    AchillesEntityManager(AchillesEntityManagerFactory entityManagerFactory, Map<Class<?>, EntityMeta> entityMetaMap, //
     ...
     *            Found entity or null if no entity is found
     */
    public abstract <T> T find(final Class<T> entityClass, final Object primaryKey, ConsistencyLevel readLevel);
     ...
     *            Found entity or null if no entity is found
     */
    public abstract <T> T getReference(final Class<T> entityClass, final Object primaryKey, ConsistencyLevel readLevel);
    ...
    protected void setMerger(EntityMerger<CONTEXT> merger) {
        this.merger = merger;
    }

    protected void setRefresher(EntityRefresher<CONTEXT> refresher) {
