...
public class EntityRefresher<CONTEXT extends PersistenceContext> {
	private static final Logger log = LoggerFactory
			.getLogger(EntityRefresher.class);
	...
	public EntityRefresher(EntityLoader<CONTEXT> loader,
			EntityProxifier<CONTEXT> proxifier) {
		this.loader = loader;
	...
	public <T> void refresh(CONTEXT context)
		...
		log.debug("Refreshing entity of class {} and primary key {}", context
				.getEntityClass().getCanonicalName(), primaryKey);

		Object entity = context.getEntity();

		EntityInterceptor<CONTEXT, Object> interceptor = proxifier
		...
		if (freshEntity == null) {
			throw new AchillesStaleObjectStateException("The entity '" + entity
