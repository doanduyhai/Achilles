...
public class BeanValidator {
    ...
    public static void validateNoDuplicateNames(AptUtils aptUtils, TypeName rawClassType, List<TypeParsingResult> parsingResults) {
    ...
    public static void validateCqlColumnNotReservedWords(AptUtils aptUtils, TypeName rawClassType, List<TypeParsingResult> parsingResults) {
        parsingResults
                .stream()
    ...
    public static void validateStaticColumns(AptUtils aptUtils, TypeName rawClassType, List<TypeParsingResult> parsingResults) {
    ...
    public static boolean isCounterTable(AptUtils aptUtils, TypeName rawClassType, List<TypeParsingResult> parsingResults) {
    ...
    public static void validateComputed(AptUtils aptUtils, TypeName rawClassType, List<TypeParsingResult> parsingResults) {
