...
public class Tuple10Property<ENTITY, A, B, C, D, E, F, G, H, I, J> extends AbstractTupleProperty<ENTITY, Tuple10<A, B, C, D, E, F, G, H, I, J>> {
    ...
    @Override
    TupleValue encodeFromJavaInternal(Tuple10<A, B, C, D, E, F, G, H, I, J> tuple10, Optional<Options> cassandraOptions) {
        if (LOGGER.isTraceEnabled()) {
            LOGGER.trace(format("Encode from Java '%s' tuple10 %s to CQL type", fieldName, tuple10));
        }

        return tupleType.newValue(
                aProperty.encodeFromRaw(tuple10._1(), cassandraOptions),
                bProperty.encodeFromRaw(tuple10._2(), cassandraOptions),
                cProperty.encodeFromRaw(tuple10._3(), cassandraOptions),
                dProperty.encodeFromRaw(tuple10._4(), cassandraOptions),
                eProperty.encodeFromRaw(tuple10._5(), cassandraOptions),
                fProperty.encodeFromRaw(tuple10._6(), cassandraOptions),
                gProperty.encodeFromRaw(tuple10._7(), cassandraOptions),
                hProperty.encodeFromRaw(tuple10._8(), cassandraOptions),
                iProperty.encodeFromRaw(tuple10._9(), cassandraOptions),
                jProperty.encodeFromRaw(tuple10._10(), cassandraOptions));
    }
    ...
    TupleValue encodeFromRawInternal(Object o, Optional<Options> cassandraOptions) {
        ...
        return encodeFromJava((Tuple10<A, B, C, D, E, F, G, H, I, J>) o, cassandraOptions);
    }
    ...
    public TupleType buildType(Optional<Options> cassandraOptions) {
        ...
        return tupleTypeFactory.typeFor(
                ...
                jProperty.buildType(cassandraOptions));
    }
