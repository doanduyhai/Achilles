...
public class Tuple4Property<ENTITY, A, B, C, D> extends AbstractTupleProperty<ENTITY, Tuple4<A, B, C, D>> {
    ...
    @Override
    TupleValue encodeFromJavaInternal(Tuple4<A, B, C, D> tuple4) {
        if (LOGGER.isTraceEnabled()) {
            LOGGER.trace(format("Encode from Java '%s' tuple4 %s to CQL type", fieldName, tuple4));
        }

        return tupleType.newValue(
                aProperty.encodeFromRaw(tuple4._1()),
                bProperty.encodeFromRaw(tuple4._2()),
                cProperty.encodeFromRaw(tuple4._3()),
                dProperty.encodeFromRaw(tuple4._4()));
    }
    ...
    TupleValue encodeFromRawInternal(Object o) {
        ...
        Validator.validateTrue(Tuple4.class.isAssignableFrom(o.getClass()), "The class of object {} to encode should be Tuple4", o);
        return encodeFromJava((Tuple4<A, B, C, D>) o);
    }
