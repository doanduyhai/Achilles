...
public class InternalSystemFunctionRegistry {
    ...
    static {
        NUMERIC_TYPES
                ...
                .forEach(targetType -> {
                    ...
                    NUMERIC_TYPES.stream().filter(x -> !x.equals(targetType)).forEach(sourceType -> {
                        ...
                        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAs" + name, returnTypeSignature,
                                asList(new FunctionParamSignature("input", sourceType, sourceType, targetCQLDataType))));
                    });
                    ...
                    SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsText", new FunctionParamSignature("returnType", STRING, STRING, "text"),
                            asList(new FunctionParamSignature("input", targetType, targetType, targetCQLDataType))));
                });


        final FunctionParamSignature stringReturnSignature = new FunctionParamSignature("returnType", STRING, STRING, "text");
        ...
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsText", stringReturnSignature, asList(booleanInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsText", stringReturnSignature, asList(inetInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsText", stringReturnSignature, asList(uuidInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsText", stringReturnSignature, asList(timestampInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsText", stringReturnSignature, asList(dateInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsTimestamp", timestampReturnSignature, asList(timestampInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsTimestamp", timestampReturnSignature, asList(timeUuidInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsDate", dateReturnSignature, asList(timestampInput)));
        SYSTEM_FUNCTIONS.add(new FunctionSignature(empty(), SYSTEM_FUNCTION_REGISTRY, "cast", "castAsDate", dateReturnSignature, asList(timeUuidInput)));
