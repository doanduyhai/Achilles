...
public class Create extends SchemaStatement {
    ...
    private Map<String, DataType> partitionColumnsMap = new LinkedHashMap<>();
    private Map<String, DataType> clusteringColumnsMap = new LinkedHashMap<>();
    private Map<String, DataType> simpleColumnsMap = new LinkedHashMap<>();
    private Map<String, DataType> staticColumnsMap = new LinkedHashMap<>();
