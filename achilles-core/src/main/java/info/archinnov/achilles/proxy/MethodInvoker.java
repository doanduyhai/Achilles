...
public class MethodInvoker
{
	...
	public List<Object> determineMultiKeyValues(Object primaryKey, List<Method> componentGetters)
	{
		log.debug("Determine multi-key components for entity {} ", primaryKey);
