...
import info.archinnov.achilles.proxy.wrapper.builder.AchillesMapWrapperBuilder;
import info.archinnov.achilles.proxy.wrapper.builder.AchillesSetWrapperBuilder;
		...
		switch (propertyMeta.type())
		{
			...
			case JOIN_LIST:
				if (rawValue != null)
				{
					...
					result = AchillesListWrapperBuilder
			...
			case JOIN_SET:
				if (rawValue != null)
				{
					...
					result = AchillesSetWrapperBuilder
							.builder(context, set)
							.dirtyMap(dirtyMap)
							.setter(propertyMeta.getSetter())
							.propertyMeta(this.<Void, V> getPropertyMetaByProperty(method))
			...
			case JOIN_MAP:
				if (rawValue != null)
				{
					...
					result = AchillesMapWrapperBuilder //
							.builder(context, map)
							.dirtyMap(dirtyMap)
							.setter(propertyMeta.getSetter())
