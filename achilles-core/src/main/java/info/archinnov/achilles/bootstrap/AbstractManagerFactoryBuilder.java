...
<<<<<<< HEAD
     ...
     * @see <a href="https://github.com/doanduyhai/Achilles/wiki/Configuration-Parameters#ddl" target="_blank">Table generation</a>
     */
    public T ignoreMissingUDTFields(boolean ignoreMissingUDTFields) {
        configMap.put(IGNORE_MISSING_UDT_FIELDS, ignoreMissingUDTFields);
        return getThis();
    }
     ...
     * @see <a href="https://github.com/doanduyhai/Achilles/wiki/Configuration-Parameters#ddl" target="_blank">Table generation</a>
     */
    public T schemaValidationEnabled(boolean schemaValidationEnabled) {
        configMap.put(SCHEMA_VALIDATION_ENABLED, schemaValidationEnabled);
        return getThis();
    }
