...
public class DeleteFromPartition<TYPE> extends DeletePartitionRoot<TYPE,DeleteFromPartition<TYPE>> {

    protected DeleteFromPartition(SliceQueryExecutor sliceQueryExecutor, Class<TYPE> entityClass, EntityMeta meta, SliceQueryProperties.SliceType sliceType) {
        super(sliceQueryExecutor, entityClass, meta, sliceType);
    }

    @Override
    protected DeleteFromPartition<TYPE> getThis() {
