...
import static info.archinnov.achilles.helper.AchillesLoggerHelper.fieldToStringFn;
import info.archinnov.achilles.annotations.Consistency;
import info.archinnov.achilles.configuration.AchillesConfigurationParameters;
import info.archinnov.achilles.consistency.AchillesConsistencyLevelPolicy;
import info.archinnov.achilles.entity.parsing.AchillesPropertyFilter;
...
public class AchillesEntityIntrospector
{
	...
	{
		log
				.debug("Find private field with name {} having annotation {} from hierarchy for entity class {}",
