...
/**
 * AchillesPropertyHelper
 * 
 * @author DuyHai DOAN
 * 
 */
public class AchillesPropertyHelper
{
	private static final Logger log = LoggerFactory.getLogger(AchillesPropertyHelper.class);
	...
	public MultiKeyProperties parseMultiKey(Class<?> keyClass)
	{
		...
		for (Field multiKeyField : keyClass.getDeclaredFields())
		{
			...
			if (keyAnnotation != null)
			{
				...
				AchillesPropertyParsingValidator.validateAllowedTypes(
						keySubType,
						allowedTypes,
