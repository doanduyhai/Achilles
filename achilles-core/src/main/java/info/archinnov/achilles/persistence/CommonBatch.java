...
abstract class CommonBatch extends CommonPersistenceManager {
    ...
    public void batchNativeStatementWithLWTListener(Statement statement, LWTResultListener LWTResultListener, Object... boundValues) {
        ...
        final NativeStatementWrapper nativeStatementWrapper = new NativeStatementWrapper(daoContext.getDriverConfig(), NativeQueryLog.class, statement, boundValues, Optional.fromNullable(LWTResultListener));
