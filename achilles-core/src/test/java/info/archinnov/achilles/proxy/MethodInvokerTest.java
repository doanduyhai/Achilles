...
public class MethodInvokerTest
{
    ...
    public void should_determine_compound_key() throws Exception
    {
        ...
        List<Object> multiKeyList = invoker.extractCompoundKeyComponents(multiKey,
    ...
    public void should_determine_compound_key_with_enum() throws Exception
    {
        ...
        compoundKey.setType(COMPOUND_ID);

        List<Object> components = invoker.extractCompoundKeyComponents(compoundKey,
    ...
    {
        assertThat(invoker.extractCompoundKeyComponents(null, new ArrayList<Method>())).isEmpty();
    }
