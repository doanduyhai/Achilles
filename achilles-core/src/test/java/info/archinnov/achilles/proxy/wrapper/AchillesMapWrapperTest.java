...
public class AchillesMapWrapperTest
{
	@Mock
	...
	public void should_get_value() throws Exception
	{
		...
		AchillesMapWrapper<Integer, String> wrapper = prepareMapWrapper(target);
	...
	public void should_get_join_value() throws Exception
	{
		...
		AchillesMapWrapper<Integer, UserBean> wrapper = prepareJoinMapWrapper(target);
	...
	private AchillesMapWrapper<Integer, UserBean> prepareJoinMapWrapper(
			Map<Integer, UserBean> target)
	{
		AchillesMapWrapper<Integer, UserBean> wrapper = new AchillesMapWrapper<Integer, UserBean>(
				target);
	...
	private AchillesMapWrapper<Integer, String> prepareMapWrapper(Map<Integer, String> target)
	{
		AchillesMapWrapper<Integer, String> wrapper = new AchillesMapWrapper<Integer, String>(
				target);
		wrapper.setDirtyMap(dirtyMap);
		wrapper.setSetter(setter);
