...
public class NativeStatementWrapperTest {
    ...
    public void should_build_parameterized_statement() throws Exception {
        ...
        final NativeStatementWrapper wrapper = new NativeStatementWrapper(driverConfig, NativeQueryLog.class, statement, new Object[] { 10L }, Optional.<LWTResultListener>absent());
        final ByteBuffer[] boundValues = new SimpleStatement("select", 10L).getValues(ProtocolVersion.V2, driverConfig.getCodecRegistry());
        ...
        assertThat(actual.getValues(ProtocolVersion.V2, driverConfig.getCodecRegistry())).hasSize(1);
        assertThat(actual.getValues(ProtocolVersion.V2, driverConfig.getCodecRegistry())).isEqualTo(boundValues);
    }
    ...
    public void should_return_regular_statement() throws Exception {
        ...
        statement.setConsistencyLevel(ConsistencyLevel.ALL);
        statement.setSerialConsistencyLevel(ConsistencyLevel.LOCAL_SERIAL);
        final NativeStatementWrapper wrapper = new NativeStatementWrapper(driverConfig, NativeQueryLog.class, statement, new Object[] {}, Optional.<LWTResultListener>absent());
        ...
        assertThat(actual.getQueryString()).isEqualTo(statement.getQueryString());
        assertThat(actual.getValues(ProtocolVersion.V2, driverConfig.getCodecRegistry())).isNotEmpty();
        assertThat(actual.getConsistencyLevel()).isEqualTo(ConsistencyLevel.ALL);
        assertThat(actual.getSerialConsistencyLevel()).isEqualTo(ConsistencyLevel.LOCAL_SERIAL);
    }
