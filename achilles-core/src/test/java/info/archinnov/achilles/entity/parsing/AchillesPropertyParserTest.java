...
public class AchillesPropertyParserTest {
    ...
    public void should_parse_primary_key() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("id"));
    ...
    @Test
    public void should_parse_multikey_primary_key() throws Exception {
        @SuppressWarnings("unused")
        class Test {
        ...
        PropertyMeta<Void, ClusteredId> meta = (PropertyMeta<Void, ClusteredId>) parser.parse(context);
    ...
    public void should_parse_simple_property_string() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("name"));
        ...
        assertThat((PropertyMeta<Void, String>) context.getPropertyMetas().get("name")).isSameAs(meta);
    ...
    public void should_parse_primitive_property() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("active"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_parse_counter_property() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("counter"));
    ...
    public void should_parse_enum_property() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("type"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_parse_allowed_type_property() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("uuid"));
    ...
    public void should_parse_lazy() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("friends"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_parse_set() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("followers"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_parse_map() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("preferences"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_parse_wide_map() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("tweets"));
        PropertyMeta<?, ?> meta = parser.parse(context);
    ...
    public void should_exception_when_no_external_cf_defined_for_widemap() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("wideMap"));
    ...
    public void should_parse_counter_widemap() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("counters"));
    ...
    public void should_exception_when_no_external_cf_defined_for_counter_widemap() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("counterWideMap"));
    ...
    @Test
    public void should_exception_when_consistency_level_defined_for_counter_widemap() throws Exception {
        @SuppressWarnings("unused")
        class Test {
        ...
        expectedEx.expect(AchillesBeanMappingException.class);
        expectedEx.expectMessage("Counter WideMap type '" + Test.class.getCanonicalName()
    ...
    public void should_exception_when_wide_row_has_external_wide_map() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("external"));
    ...
    public void should_fill_join_widemap_hashmap() throws Exception {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("beans"));
    ...
    public void should_fill_widemap_hashmap_when_wide_row() throws Exception {
        ...
        Entry<PropertyMeta<?, ?>, String> entry = context.getWideMaps().entrySet().iterator().next();
    ...
    public void should_exception_when_invalid_wide_map_key() throws Exception {
        ...
        expectedEx.expect(AchillesBeanMappingException.class);
        expectedEx.expectMessage("The class '" + Void.class.getCanonicalName() + "' is not allowed as WideMap key");
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("tweets"));
    ...
    public void should_parse_multi_key_wide_map() throws Exception {
        ...
        assertThat((Class<String>) multiKeyProperties.getComponentClasses().get(0)).isEqualTo(String.class);
        assertThat((Class<Integer>) multiKeyProperties.getComponentClasses().get(1)).isEqualTo(int.class);
    }
    ...
    public void should_exception_when_field_not_serializable() throws Exception {
        ...
        class Test {
            @Column
            private AchillesPropertyParser parser;

            public AchillesPropertyParser getParser() {
                return parser;
            }

            public void setParser(AchillesPropertyParser parser) {
                this.parser = parser;
            }
        }
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("parser"));
    ...
    public void should_exception_when_value_of_list_not_serializable() throws Exception {
        ...
        class Test {
            @Column
            private List<AchillesPropertyParser> parsers;

            public List<AchillesPropertyParser> getParsers() {
                return parsers;
            }

            public void setParsers(List<AchillesPropertyParser> parsers) {
        ...
        AchillesPropertyParsingContext context = newContext(Test.class, Test.class.getDeclaredField("parsers"));
    ...
    public void should_exception_when_value_of_set_not_serializable() throws Exception {
        ...
        class Test {
            @Column
            private Set<AchillesPropertyParser> parsers;

            public Set<AchillesPropertyParser> getParsers() {
                return parsers;
            }

            public void setParsers(Set<AchillesPropertyParser> parsers) {
                this.parsers = parsers;
            }
        }
    ...
    public void should_exception_when_value_and_key_of_map_not_serializable() throws Exception {
        ...
        class Test {
            @Column
            private Map<AchillesPropertyParser, AchillesPropertyParser> parsers;

            public Map<AchillesPropertyParser, AchillesPropertyParser> getParsers() {
                return parsers;
            }

            public void setParsers(Map<AchillesPropertyParser, AchillesPropertyParser> parsers) {
                this.parsers = parsers;
            }
        }
