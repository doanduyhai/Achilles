...
@APUnitTest
public class TestEntityWithTwoCustomConstructors {
    ...
    @EntityCreator
    public TestEntityWithTwoCustomConstructors(UUID id, Date date, Double value) {
        this.id = id;
        this.date = date;
        this.value = value;
    }
    ...
    @EntityCreator
    public TestEntityWithTwoCustomConstructors(UUID id, Date date) {
        this.id = id;
        this.date = date;
    }
